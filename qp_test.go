...
func TestQuotedPrintable(t *testing.T) {
	tests := []struct {
		...
		{in: "foo bar=ab", want: "foo bar", err: "qp: invalid quoted-printable hex byte 0x61"},
		{in: "foo bar=0D=0A", want: "foo bar\r\n"},
		{in: " A B        \r\n C ", want: " A B\r\n C"},
		{in: " A B =\r\n C ", want: " A B  C"},
		{in: " A B =\n C ", want: " A B  C"}, // lax. treating LF as CRLF
		{in: "foo=\nbar", want: "foobar"},
		{in: "foo\x00bar", want: "foo", err: "qp: invalid unescaped byte 0x00 in quoted-printable body"},
		{in: "foo bar\xff", want: "foo bar", err: "qp: invalid unescaped byte 0xff in quoted-printable body"},
		...
		{in: "foo=\r\nbar", want: "foobar"},
		{in: "foo=\nbar", want: "foobar"},
		{in: "foo=\rbar", want: "foo", err: "qp: invalid quoted-printable hex byte 0x0d"},
		{in: "foo=\r\r\r \nbar", want: "foo", err: `qp: invalid bytes after =: "\r\r\r \n"`},
...
qp: invalid quoted-printable hex byte 0x0a: 1190
qp: invalid quoted-printable hex byte 0x0d: 3325
qp: invalid quoted-printable hex byte 0x20: 3325
qp: invalid quoted-printable hex byte 0x3d: 810
unexpected EOF: 1502`
	if got != want {
		t.Errorf("Got:\n%s\nWant:\n%s", got, want)
	}
